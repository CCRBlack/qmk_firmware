// path: qmk_firmware/keyboards/gmmk/pro/iso/keymaps/ccrblack/rgb_matrix_map.h
    ...
    enum led_location_map {
        ...
        LED_L1,     // 68, LED, l01
        LED_R1,     // 69, LED, l11
        LED_DEL,    // 70, Prt, k97 -- Remapped to DEL
        LED_L2,     // 71, LED, l02
        LED_R2,     // 72, LED, l12
        LED_PRT,    // 73, Del, k65 -- Remapped to PRT
        LED_L3,     // 74, LED, l03
        LED_R3,     // 75, LED, l13
    ...
    const uint8_t LED_LIST_FUNC[] = {LED_PRT, LED_PGUP, LED_PGDN, LED_END};
